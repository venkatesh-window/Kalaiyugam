...
export const pillars: Pillar[] = [
  ...
  { name: "Speed Networking", instrument: "Rhythm", description: "Every connection is a beat, building the tempo." },
  { name: "Events", instrument: "The Stage", description: "Where the symphony is performed live." },
  { name: "Web", instrument: "Resonance", description: "The medium that carries the sound further." },
];
