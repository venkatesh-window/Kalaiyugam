        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-parchment/60 leading-relaxed max-w-lg font-light tracking-wide">
              Kalaiyugam: A Symphony of Emotions, is a flagship event conducted by Team Impact, the Student Community of Chennai Institute of Technology, to be held from August 18–19, 2026.
            </motion.p>
