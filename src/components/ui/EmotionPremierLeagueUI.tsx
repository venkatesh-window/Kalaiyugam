          ...
          <div className="bg-parchment/5 border border-parchment/10 rounded-2xl p-8 backdrop-blur-sm max-w-md w-full text-center hover:border-marigold/30 transition-colors">
            ...
            <div className="flex flex-col gap-3 mt-4">
              <div className="flex items-center justify-between px-4 py-2 bg-parchment/5 rounded-lg">
                <span className="text-parchment/90 font-medium">Vishali</span>
                <span className="text-marigold/80 font-mono text-sm">86101 37727</span>
              </div>
              <div className="flex items-center justify-between px-4 py-2 bg-parchment/5 rounded-lg">
                <span className="text-parchment/90 font-medium">Prithish</span>
                <span className="text-marigold/80 font-mono text-sm">89392 43866</span>
              </div>
            </div>
          </div>
        </motion.div>
