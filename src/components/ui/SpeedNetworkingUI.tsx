          ...
          <div className="bg-parchment/5 border border-parchment/10 rounded-2xl p-8 backdrop-blur-sm max-w-md w-full text-center hover:border-marigold/30 transition-colors">
            ...
            <div className="flex flex-col gap-3 mt-4">
              <div className="flex items-center justify-between px-4 py-2 bg-parchment/5 rounded-lg">
                <span className="text-parchment/90 font-medium">Amarnath</span>
                <span className="text-marigold/80 font-mono text-sm">82487 39046</span>
              </div>
              <div className="flex items-center justify-between px-4 py-2 bg-parchment/5 rounded-lg">
                <span className="text-parchment/90 font-medium">Yash</span>
                <span className="text-marigold/80 font-mono text-sm">63835 45318</span>
              </div>
            </div>
          </div>
        </motion.div>
