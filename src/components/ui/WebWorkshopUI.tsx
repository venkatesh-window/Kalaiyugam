  ...
  return (
    <div className="w-full min-h-screen bg-ink text-parchment overflow-hidden">
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[10%] right-[10%] w-[40vw] h-[40vw] bg-cyan-500/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-[10%] left-[-10%] w-[30vw] h-[30vw] bg-blue-500/5 rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        <motion.div variants={item} className="text-center mb-20 relative">
          <div className="flex justify-center flex-wrap gap-4 mb-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-500/5 text-cyan-400 text-xs uppercase tracking-widest font-semibold">
              <Code size={14} />
          ...
          <h1 className="font-display text-5xl md:text-7xl uppercase tracking-widest leading-none mb-6">
            ...
            <span className="block text-3xl md:text-5xl mt-4 text-cyan-400 tracking-[0.2em]">Workshop</span>
          </h1>
        ...
        <motion.div variants={item} className="mb-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-parchment/5 border border-parchment/10 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
            <h3 className="text-cyan-400 uppercase tracking-widest text-sm font-semibold mb-4">The Strategy</h3>
            ...
            <div className="flex flex-col gap-4 mt-8">
               <h4 className="text-cyan-400 uppercase tracking-widest text-xs font-semibold">Pro-Inputs: Pre-event Homework</h4>
               <div className="bg-cyan-500/10 border border-cyan-500/20 rounded p-4 text-sm text-parchment/90">
          ...
          <div className="bg-gradient-to-br from-cyan-500/10 to-ink border border-cyan-500/20 rounded-2xl p-8 backdrop-blur-sm">
            <h3 className="text-cyan-400 uppercase tracking-widest text-sm font-semibold mb-6 flex items-center gap-2">
               <Layers size={18} /> Zero-Install Tech Stack
            </h3>
            
            <div className="space-y-6">
               <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded bg-cyan-500/20 text-cyan-400 flex items-center justify-center shrink-0">
                     <Zap size={20} />
                  </div>
                  <div>
        ...
        <motion.div variants={item} className="mb-24">
           <div className="bg-parchment/5 border border-parchment/10 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
             <h3 className="text-cyan-400 uppercase tracking-widest text-sm font-semibold mb-8 flex items-center gap-2">
                <Timer size={18} /> The 90-Minute Sprint Schedule
             </h3>
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-ink/50 border border-parchment/5 p-4 rounded-xl">
                   <div className="text-cyan-400 font-mono text-xs mb-1">0:00 - 0:15 (15m)</div>
                ...
                <div className="bg-ink/50 border border-parchment/5 p-4 rounded-xl">
                   <div className="text-cyan-400 font-mono text-xs mb-1">0:15 - 0:35 (20m)</div>
                ...
                <div className="bg-ink/50 border border-parchment/5 p-4 rounded-xl">
                   <div className="text-cyan-400 font-mono text-xs mb-1">0:35 - 0:50 (15m)</div>
                ...
                <div className="bg-ink/50 border border-parchment/5 p-4 rounded-xl">
                   <div className="text-cyan-400 font-mono text-xs mb-1">0:50 - 1:00 (10m)</div>
                ...
                <div className="bg-ink/50 border border-parchment/5 p-4 rounded-xl">
                   <div className="text-cyan-400 font-mono text-xs mb-1">1:00 - 1:25 (25m)</div>
                ...
                <div className="bg-ink/50 border border-parchment/5 p-4 rounded-xl">
                   <div className="text-cyan-400 font-mono text-xs mb-1">1:25 - 1:30 (5m)</div>
             ...
             <div className="mt-12 pt-8 border-t border-parchment/10">
                <h4 className="text-cyan-400 uppercase tracking-widest text-xs font-semibold mb-6">MVP Battle Criteria (100 Points Total)</h4>
        ...
        <motion.div variants={item} className="text-center pb-12">
          <button 
            ...
            className="group relative inline-flex items-center justify-center px-10 py-5 font-sans font-semibold tracking-[0.2em] uppercase text-sm bg-cyan-500 text-ink overflow-hidden rounded-full transition-transform hover:scale-105 active:scale-95"
          >
